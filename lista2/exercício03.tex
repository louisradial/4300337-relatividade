...
% Alternativamente, consideremos \(\dl{m} = \sigma \dl{\tau}\) na equação diferencial, onde obtemos
% \begin{align*}
%     \frac{\sigma \dl{\tau}}{M\sqrt{\frac{1-\beta}{1+\beta}}} + \frac{\dl{\beta}}{1-\beta^2} = 0 &\implies \frac{\sigma\dl{t}}{M \gamma}\sqrt{\frac{1+\beta}{1-\beta}} + \gamma^2 \dl{\beta} = 0\\
%                                                                                                 &\implies \frac{\sigma}{M}\dl{t} = - \frac{\gamma^3 \sqrt{1-\beta}}{\sqrt{1+\beta}}\dl{\beta}\\
%                                                                                                 &\implies \frac{\sigma}{M}\dl{t} = - (1 - \beta)^{-1}(1+\beta)^{-2}
% \end{align*}
